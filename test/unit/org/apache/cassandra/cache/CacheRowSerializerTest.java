...
public class CacheRowSerializerTest
{
    ...
    public void testBinarySearch()
    {
        ...
        ByteBuffer row = CacheRowSerializer.serialize(columnFamily);

        int i = CacheRowSerializer.binarySearch(row, ByteBufferUtil.bytes(3), BytesType.instance);
        assertEquals(3, i);

        IColumn column = CacheRowSerializer.deserializeColumn(row, ByteBufferUtil.bytes(3), BytesType.instance);
    ...
    public void testAppendRow()
    {
        ...
        CacheRowSerializer.appendRow(row, columns, EMPTY_BYTE_BUFFER, EMPTY_BYTE_BUFFER, 0, false, BytesType.instance);
