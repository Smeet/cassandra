...
public class CachedRowSliceIteratorTest
{
    ...
    public void testLimit()
    {
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, end, 9, false, true);
        for (int i = 0; i < 9; i++)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, end, 1, false, true);
        for (int i = 0; i < 1; i++)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, end, 4, false, true);
        for (int i = 0; i < 4; i++)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
    ...
    public void testStartAndEndRestrainedSlicing()
    {
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, end, 0, false, true);
        for (int i = 0; i < 10; i++)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, end, 10, false, false);
        for (int i = 0; i < 10; i++)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, end, 0, true, true);
        for (int i = 9; i>=0; i--)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, end, 10, true, false);
        for (int i = 9; i>=0; i--)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
    ...
    public void testEndRestrainedSlicing()
    {
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, EMPTY_BYTE_BUFFER, end, 0, false, true);
        for (int i = 0; i < 10; i++)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, EMPTY_BYTE_BUFFER, end, 10, false, false);
        for (int i = 0; i < 10; i++)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, EMPTY_BYTE_BUFFER, end, 0, true, true);
        for (int i = 9; i>=0; i--)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, EMPTY_BYTE_BUFFER, end, 10, true, false);
        for (int i = 9; i>=0; i--)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
    ...
    public void testStartRestrainedSlicing()
    {
        ...
        // before first colum
        start = bytes(0);
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, EMPTY_BYTE_BUFFER, 0, false, true);
        for (int i = 0; i < 10; i++)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, EMPTY_BYTE_BUFFER, 10, false, false);
        for (int i = 0; i < 10; i++)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        // before first column
        start = bytes(21);
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, EMPTY_BYTE_BUFFER, 0, true, true);
        for (int i = 9; i>=0; i--)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
        ...
        iter = new CachedRowSliceIterator(CF_META_DATA, getRow(10), null, start, EMPTY_BYTE_BUFFER, 10, true, false);
        for (int i = 9; i>=0; i--)
        {
            IColumn next = iter.next();
            assertEquals(bytes(i * 2 + 2), next.name());
    ...
    private FileDataInput getRow(int numCols) 
    {
        ColumnFamily columnFamily = getColumnFamily(numCols);
        ByteBuffer buffer = CacheRowSerializer.serialize(columnFamily);
        return new CachedDataInput(buffer);
    }
