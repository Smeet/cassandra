...
{
    private static Logger logger = LoggerFactory.getLogger(SSTCacheCollationController.class);

    private final ColumnFamilyStore cfs;
    private final DataTracker.View _view;
    private final CachedDataInput dataInput;
    private final QueryFilter filter;
    private final int gcBefore;

    public SSTCacheCollationController(ColumnFamilyStore cfs, DataTracker.View view, CachedDataInput dataInput, QueryFilter filter, int gcBefore)
    {
        this.cfs = cfs;
        _view = view;
    ...
    private ColumnFamily collectTimeOrderedData()
    {
        ...
        try
        {
            for (Memtable memtable : Iterables.concat(Collections.singleton(_view.memtable), _view.memtablesPendingFlush))
            {
